...
class TestSafeExecute:
    ...
    def test_with_custom_error_message(self):
        ...
        wrapped = safe_execute(
            failing_func, error_message="Custom error", default_return=None
        )
        result = wrapped()
...
class TestValidateAndExecute:
    ...
    def test_custom_error_class(self):
        ...
        @validate_and_execute(
            validator, error_class=ConfigurationError, error_message="Config error"
        )
        def process(x):
            return x
...
class TestErrorHandler:
    ...
    def test_handle_error_without_raise(self):
        ...
        result = handler.handle_error(
            error, "test_context", raise_error=False, default_return="default_value"
        )
